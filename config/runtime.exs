...
#
#     PHX_SERVER=true bin/elixir_gsa_tv_dashboard start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :elixir_gsa_tv_dashboard, ElixirGsaTvDashboardWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :elixir_gsa_tv_dashboard, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
