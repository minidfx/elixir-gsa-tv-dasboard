...
config :elixir_gsa_tv_dashboard, ElixirGsaTvDashboardWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "0ZIARC1f/TMzLDS+Qm+Y2PWq4PXJUxPzozMoEYaFOW0bo/oUY3WMH9V7vRV2Swfe",
  watchers: [
...
config :elixir_gsa_tv_dashboard, ElixirGsaTvDashboardWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/elixir_gsa_tv_dashboard_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :elixir_gsa_tv_dashboard, dev_routes: true
